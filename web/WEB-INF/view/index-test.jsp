        ...
        <%--<div class="top">--%>
            ...
            <%--<ul class="top-right">--%>
                ...
                <%--<li>--%>
                    ...
                    <%--</c:choose>--%>
                <%--</li>--%>
                <%--<li class="login"><a href="/getRegister.action">免费注册</a></li>--%>
            <%--</ul>--%>
        <%--</div>--%>
    <%--</div>--%>
    <%--<div class="outer">--%>
        <%--<main>--%>
            <%--<div id="myCarousel" class="carousel slide" data-ride="carousel">--%>
                ...
                <%--</a>--%>
            <%--</div>--%>
                <%--&lt;%&ndash;<c:forEach items="${applicationScope.hotList}" var="tourism">&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<img class="hot-img" src="${applicationScope.imagesUrl}${tourism.imageUrl}">&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<div class="hot-text">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<p>${tourism.id}</p>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<p>${tourism.name}</p>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<p>${tourism.price}</p>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<p>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<fmt:formatDate value="${tourism.beginTime}" type="date" pattern="yyyy-M-d"/>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</p>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<a href="/details/tourism/${tourism.id}">详情</a>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
